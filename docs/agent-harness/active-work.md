...
Last verified: Task 7 copied the cross-project skill byte-for-byte from staff; fresh-agent RED/GREEN planning evidence and SHA-256 parity passed on 2026-08-02. Run both harness checks before relying on this handoff.
